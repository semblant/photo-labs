...
const PhotoDetailsModal = ({ photo, onClosePhotoDetailsModal, favourites, updateToFavPhotoIds }) => {
  ...
  return (
    ...
    <div key={id} className="photo-details-modal">
      ...
      <div className='photo-details-modal__images'>
        <PhotoFavButton key={photo.id} photo={photo} favourites={favourites} updateToFavPhotoIds={updateToFavPhotoIds}/>
        ...
        <div className='photo-details-modal__images'>
          <PhotoList photos={similarPhotos} favourites={favourites} updateToFavPhotoIds={updateToFavPhotoIds}/>
        </div>
      </div>
    </div>
  )
